            ...
            <ion-list class="ion-justify-content-center">
                <ion-item>
                    <router-link to="/add_concert">
                        <ion-button class="button" expand="full" @click="" color="success" fill="solid" shape="round" size="small">Créer un concert</ion-button>
                    </router-link>
                </ion-item>
                <ion-item>
                ...
                <ion-item>
                    <ion-button expand="full" @click="forceListCategories" color="warning"  fill="solid" shape="round" size="small">Gérer les catégories</ion-button>
                </ion-item>
                <ion-item>
                    <ion-button expand="full" @click="forceListUsers" color="medium"  fill="solid" shape="round" size="small">Gérer les utilisateurs</ion-button>
                </ion-item>
            </ion-list>
        </ion-content>
    </ion-page>
...
const forceListCategories = () => {
    window.location.href = "/list_categories";
};

const forceListUsers = () => {
